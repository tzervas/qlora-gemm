pub mod scalar {
    pub mod f32 {
        ...
        pub const H_CPLX_UKR: [[qlora_gemm_common::microkernel::HMicroKernelFn<num_complex::Complex<T>>;
            H_CPLX_N]; H_CPLX_M] = [];
    }
}
...
pub mod fma {
    pub mod f32 {
        ...
        use qlora_gemm_common::pulp::u32x8;
...
pub mod neonfcma {
    pub mod c32 {
        ...
        pub const H_UKR: [[qlora_gemm_common::microkernel::HMicroKernelFn<T>; H_N]; H_M] = [];
    }
}
