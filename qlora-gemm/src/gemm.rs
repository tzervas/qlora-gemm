...
#[cfg(feature = "f16")]
#[allow(non_camel_case_types)]
pub type f16 = qlora_gemm_f16::f16;
...
unsafe fn gemm_dispatch<T: 'static>(
    ...
    if TypeId::of::<T>() == TypeId::of::<f16>() {
        return qlora_gemm_f16::gemm::f16::get_gemm_fn()(
            m,
            n,
            k,
            dst as *mut f16,
    ...
    if TypeId::of::<T>() == TypeId::of::<f64>() {
        qlora_gemm_f64::gemm::f64::get_gemm_fn()(
            m,
            n,
            k,
            dst as *mut f64,
        ...
        qlora_gemm_f32::gemm::f32::get_gemm_fn()(
            m,
            n,
            k,
            dst as *mut f32,
        ...
        qlora_gemm_c64::gemm::f64::get_gemm_fn()(
            m,
            n,
            k,
            dst as *mut c64,
        ...
        qlora_gemm_c32::gemm::f32::get_gemm_fn()(
            m,
            n,
            k,
            dst as *mut c32,
